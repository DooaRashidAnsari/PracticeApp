...
public class AppNativeModule extends ReactContextBaseJavaModule {
    public AppNativeModule(ReactApplicationContext reactContext) {
        super(reactContext);
    }
    ...
    public void greetUser(String name, Boolean isAdmin, Callback
            callback) {
        System.out.println("User Name: " + name + ", Administrator: " +
                (isAdmin ? "Yes" : "No"));
        String greeting = "Welcome " + name + ", you " + (isAdmin ?
                "are" : "are not") + " an administrator";
